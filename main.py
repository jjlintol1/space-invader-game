...
def main():
    ...
    while run:
        ...
        if (keys[pygame.K_s] or keys[pygame.K_DOWN]) and player.y + player_velocity + player.get_height() + 15 < HEIGHT: 
            player.y += player_velocity
        ...
        for enemy in enemies[:]:
            ...
            if random.randrange(0, enemy_shot_freq*60) == 1:
                enemy.shoot()
